...
public class C8 {
	...
	public static void main(String[] args) {
		...
		System.out.println("리스트를 모두 섞은 후 : " + al1);
		...
		String min = Collections.min(al1);
		System.out.println("리스트에서 최소 : " + min);
		
		String max = Collections.max(al1);
		System.out.println("리스트에서 최대 : " + max);
